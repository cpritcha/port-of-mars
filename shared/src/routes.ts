export const ASULOGIN_PAGE = 'ASULogin' as const;
...
export type Page =  'ASULogin' | 'Login' | 'WaitingLobby' | 'Game' | 'Tutorial' | 'Register' | 'Dashboard';
export const PAGES: Array<Page> = [ ASULOGIN_PAGE, LOGIN_PAGE, LOBBY_PAGE, GAME_PAGE, TUTORIAL_PAGE, REGISTER_PAGE, DASHBOARD_PAGE ];
